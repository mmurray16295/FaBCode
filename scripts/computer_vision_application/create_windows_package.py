...
def create_portable_package():
    ...
    app_files = [
        "scripts/computer_vision_application/fab_detector_app.py",
        "scripts/computer_vision_application/live_detector.py",
        "requirements.txt",
        "GUI_INSTALLER.py"
    ]
    ...
    for file in app_files:
        ...
        if src.exists():
            dest_name = Path(file).name  # Get just the filename
    ...
    data_files = [
        "card.json",
        "card_weights_all_printings.json"
    ]
