...
def build_executable():
    ...
    # Prepare paths
    main_script = project_root / "scripts" / "computer_vision_application" / "fab_detector_app.py"
    ...
    pyinstaller_args = [
        ...
        f"--add-data=data/card_weights_all_printings.json{os.pathsep}data",
...
def create_deployable_package(exe_path):
    ...
    data_files = [
        ...
        ("data/card_weights_all_printings.json", "card_weights_all_printings.json"),
    ]
