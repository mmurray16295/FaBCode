...
Model: Phase 3 (2,641 classes - Complete FaB Collection)
Package Date: 2025-10-20
Model: YOLOv11x trained on 125,000 synthetic playmat images
...
- 8GB RAM minimum (16GB recommended for Phase 3 model)
- Webcam or screen capture support
- Internet connection (for initial setup only)
- GPU recommended (CUDA-compatible) for best performance
...
- models/best.pt: Trained YOLOv11x model (345MB, 2,641 classes)
