...
class DetectorGUI:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("FaB Card Detector - Phase 3 (2,641 Classes)")
    ...
    def _create_widgets(self):
        ...
        # Title
        title = tk.Label(scrollable_frame, text="FaB Card Live Detector - Phase 3", 
                        font=("Arial", 20, "bold"))
        title.pack(pady=20)
        ...
        self.conf_label = ttk.Label(settings_frame, text="0.25")
